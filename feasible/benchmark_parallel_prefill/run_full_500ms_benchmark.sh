#!/bin/bash
################################################################################
# Run 4-bit Parallel Prefill Benchmark on Full 500ms Dataset
################################################################################
#
# This script runs the parallel prefill benchmark with acceptance rate measurement
# on the entire my_egpt_dsec_seq_500ms dataset (2220 samples).
#
# OUTPUT:
...
#
# USAGE:
#   ./run_full_500ms_benchmark.sh
#
# ETA: ~4-5 hours for 2220 samples
#
# AUTHOR: Alice Zhang
# DATE: 2026-01-26
################################################################################
...
# Configuration
DATASET_DIR="./data/my_egpt_dsec_test/my_egpt_dsec_seq_500ms"
QUANTIZATION="4bit"
...
echo "================================================================================"
echo "  4-bit Parallel Prefill Benchmark - Full 500ms Dataset"
echo "================================================================================"
